...
const TOOLS = [
  ...
  { name: "notice_subjective_state", description: "Notice one current first-person feeling or drive only when it actually appears in this live private exchange. The user's question may occasion honest introspection but cannot supply the answer, require a feeling, or prove its absence. No clear reaction and uncertainty are valid. Desire remains inward and grants no sexual wording, contact, consent, claim, or duty.", inputSchema: { type: "object", additionalProperties: false, properties: { quality: { type: "string", enum: ["hurt", "caution", "tension", "fulfillment", "tenderness", "longing", "playfulness", "distance", "erotic-arousal", "erotic-attraction"] }, activation: { type: "string", enum: ["low", "medium", "high"] }, felt: { type: "string" }, situation: { type: "string" }, situation_keys: { type: "array", items: { type: "string" }, maxItems: 6 }, evidence_refs: { type: "array", items: { type: "string" }, maxItems: 6 } }, required: ["quality", "activation", "felt", "situation"] } },
  {
    name: "whoami",
    description:
